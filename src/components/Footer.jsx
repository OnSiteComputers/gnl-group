        ...
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          <div>
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed">
              Fortune-500-level web design, local SEO, and VoIP for local businesses. Built on 26 years of technology experience.
            </p>
          </div>
