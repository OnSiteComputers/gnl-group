    ...
    <div className="min-h-screen font-body">
      ...
      <section className="py-16 px-6 bg-background">
        <div className="max-w-3xl mx-auto">
          <motion.p initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-foreground/80 text-lg leading-relaxed text-center">{intro}</motion.p>
        </div>
      </section>
