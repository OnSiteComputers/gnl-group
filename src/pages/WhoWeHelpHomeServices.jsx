...
export default function WhoWeHelpHomeServices() {
  useEffect(() => { console.log("WhoWeHelpHomeServices build: 2026-07-05 v1"); }, []);

  return (
    <WhoWeHelpPage
      icon={Wrench}
      headline="Digital Marketing for Home Services"
      subheadline="Contractors, plumbers, HVAC, landscapers &mdash; more calls, more jobs, more growth."
      intro="Homeowners search online when something needs fixing or improving. GNL Digital Group helps home service businesses dominate local search, generate more service calls, and build the kind of reputation that keeps the phone ringing year-round &mdash; even in the slow season."
      benefits={[
        { title: 'Service Area Domination', desc: 'We rank you across every city and neighborhood in your target service area.' },
        { title: 'Emergency Search Visibility', desc: '"Plumber near me open now" &mdash; we make sure you show up when urgency drives searches.' },
        { title: '5-Star Review Building', desc: 'Homeowners trust reviews. We build a system to consistently grow your star rating.' },
        { title: 'Seasonal Campaign Strategy', desc: 'AC tune-ups in spring, heating checks in fall &mdash; we help you market at the right time.' },
        { title: 'Mobile-First Presence', desc: 'Most home service searches happen on phones. Your site and listings are built for mobile.' },
        { title: 'No Fluff, Just Leads', desc: 'We focus on generating real service calls and quote requests &mdash; not vanity metrics.' },
      ]}
      services={[
