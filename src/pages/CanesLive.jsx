            ...
            {seriesFeed ? (
              <>
                ...
                <div style={styles.seriesNote}>
                  {seriesFeed?.manual
                    ? seriesFeed.autoApplied
                      ? "Best-of-7 series score auto-updated from the next final game."
                      : "Best-of-7 series score starts tied 2-2; next final game will update it."
