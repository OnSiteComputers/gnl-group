      ...
      <main style={styles.shell}>
        ...
        <section style={styles.grid}>
          <div style={styles.card}>
            <div style={styles.cardTitle}>LIVE GAME SCORE</div>
            <div style={styles.liveScoreRow}>
              <GameScoreTeam label="CANES" score={game.canes.score} accent={RED} />
              <div style={styles.seriesDash}>—</div>
              <GameScoreTeam label={game.opp.abbrev || game.opp.name || "OPP"} score={game.opp.score} accent={SILVER} />
            </div>
            <div style={styles.seriesNote}>
              This card uses the same score and opponent as the live feed.
            </div>
          </div>
...
function GameScoreTeam({ label, score, accent }) {
  return (
    <div style={styles.seriesTeam}>
      <div style={{ ...styles.seriesLabel, color: accent }}>{label}</div>
      <div style={{ ...styles.seriesWins, color: accent }}>{score}</div>
    </div>
  );
}
...
const styles = {
  ...
  liveScoreRow: { display: "flex", alignItems: "center", justifyContent: "center", gap: 34 },
