...
const CARE_MONTHLY = "$95";                       // SUGGESTED — hosting + change requests, 12-mo term
const VOIP_AFTER_YEAR1 = "$100";                  // SUGGESTED — phone service /mo after free first year
const PHONE_COUNT = "4";
        ...
        <div className="dlp-scope">
          ...
          <div className="dlp-card">
            ...
            <div className="dlp-price">
              ...
              <div><span className="dlp-amount">{CARE_MONTHLY}</span><span className="dlp-per">/month — hosting + unlimited change requests, 12-month agreement</span></div>
            </div>
          </div>
          ...
          <div className="dlp-card dlp-bonus">
            ...
            <div className="dlp-price">
              <div><span className="dlp-amount">$0</span><span className="dlp-per">first year — phones, install &amp; service all included</span></div>
              <div><span className="dlp-amount">{VOIP_AFTER_YEAR1}</span><span className="dlp-per">/month after year one — all four lines, fax included, cancel anytime</span></div>
            </div>
          </div>
        </div>
      </section>
