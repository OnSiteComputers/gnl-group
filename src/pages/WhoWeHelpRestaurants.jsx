...
export default function WhoWeHelpRestaurants() {
  return (
    <WhoWeHelpPage
      ...
      subheadline="Fill more tables and drive more orders — online and in person."
      ...
      benefits={[
        ...
        { title: 'Event & Promotion Promotion', desc: 'Happy hours, seasonal specials, and events — we help you get the word out digitally.' },
