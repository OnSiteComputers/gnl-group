    ...
    <div className="fl">
      ...
      <main className={`fl-wrap ${show ? "in" : ""}`}>
        ...
        <div className="fl-letter">
          ...
          <p>
            Sixteen years together, and you&rsquo;re still the best part of every
            day I come home to. You found the store that built this whole life of
            ours &mdash; you&rsquo;ve been part of it from the very first brick. You put
            up with my hours, my stubbornness, my perfectionism, and you&rsquo;re
            still here. That means more to me than I know how to put into words
            &mdash; so I built you a page instead, because apparently that&rsquo;s the
            language I speak best.
          </p>
          <p>
